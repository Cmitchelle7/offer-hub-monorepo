...
<Callout type="tip">
  Without the Orchestrator, building all of this could take 6-12 months. With
  it, you can integrate in a few days.
</Callout>
...
<Callout type="note">
  For production, you'll need a Stellar mainnet account with USDC trustline and
...
<Callout type="tip">
  The installation takes about 5 minutes. You'll have a running API at
  `http://localhost:4000` when you're done.
</Callout>
...
<Callout type="note">
  Need help? Join our [Discord community](https://discord.gg/offerhub) or open
  an issue on [GitHub](https://github.com/OFFER-HUB/offer-hub-monorepo/issues).
</Callout>
